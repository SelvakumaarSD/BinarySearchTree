...
public class BST<E extends Comparable<E>> implements Tree<E> {
	...
	public boolean isEqualTo(BST<E> otherTree) {
		
		TreeNode<E> otherTreeNode, thisTreeNode;
		
		otherTreeNode = otherTree.getRoot();
		thisTreeNode = this.getRoot();

		return isEqualTo(otherTreeNode, thisTreeNode);
	}

	// checks equality of two BSTs - helper method
	private boolean isEqualTo(TreeNode<E> root1, TreeNode<E> root2) {
		if (root1 == null && root2 == null){
			return true;
		}
		if (root1 != null && root2 != null){
			return (root1.element == root2.element
					&& isEqualTo(root1.left, root2.left)
					&& isEqualTo(root1.right, root2.right));
		}
		return false;
	}
